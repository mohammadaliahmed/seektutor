package com.tutor.seektutor.Activities;
...
import com.tutor.seektutor.Adapters.NotificationsListAdapter;
...
public class NotificationsList extends AppCompatActivity {
    ...
    private void getDataFromDB() {
        mDatabase.child("Notifications")
                .child(SharedPrefs.getTutor() == null ? SharedPrefs.getStudent().getUsername() : SharedPrefs.getTutor().getUsername())
    ...
    private void showAlert(final String notiId) {
        ...
        builder1.setPositiveButton(
                ...
                new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        mDatabase.child("Notifications").child(SharedPrefs.getTutor().getUsername()).child(notiId).removeValue().addOnSuccessListener(new OnSuccessListener<Void>() {
                            @Override
