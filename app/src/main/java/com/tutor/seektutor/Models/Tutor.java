...
public class Tutor {
    ...
    public Tutor(String username, String name, String password, String phone, String address,String city, String age, String gender, String fcmKey, String picUrl, long time) {
